...
function Table() {
	...
	const handleRowUpdate = (newData, oldData, resolve) => {
		...
		if (newData.explanation === "") {
			errorList.push("Please enter explanation");
		}

		if (errorList.length < 1) {
			api.patch("/terms/" + newData._id, newData)
				.then((res) => {
