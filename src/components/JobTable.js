...
function Table() {
	...
	const handleRowUpdate = (newData, oldData, resolve) => {
		...
		if (newData.job_title === "") {
			errorList.push("Please enter job_title");
		}
		if (newData.location === "") {
			errorList.push("Please enter location");
		}
		if (newData.job === "") {
			errorList.push("Please enter job");
		}
		...
		if (errorList.length < 1) {
			api.patch("/jobs/" + newData._id, newData)
				.then((res) => {
